  ...
  if (!composer) {
    return (
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#1a1a2e] to-[#0f0f1a] text-white">
        <h1 className="mb-4 text-2xl font-bold">Composer not found</h1>
        <Link href="/admin/composers" className="text-amber-400 hover:text-amber-300">
          ← Back to Composers
        </Link>
      </main>
    );
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
            <div className="w-full max-w-md rounded-2xl border border-red-500/50 bg-slate-900 p-8">
              ...
              <p className="mb-6 text-sm text-red-300">
                ⚠️ This will also delete all quizzes associated with this composer due to cascade deletion.
              </p>
              <div className="flex gap-4">
                <button
